...
class DistantDependentProbability(ProbabilityFunction):
    ...
    def __call__(self, dist):
        ...
        #print("Dist = " + str(dist))
        #print("self.min_dist =" + str(self.min_dist))
        #print("self.maxdist = " + str(self.max_dist))
...
class CorrelatedGapJunction(UnidirectionConnector):
    ...
    def conn_exist(self, sid, tid):
       ...
       # print("Sid = " + str(sid) + " tid: " + str(tid))
        if trg_dict is not None and tid in trg_dict:
           # print("trg_dict[tid]: " + str(trg_dict))
    ...
    def connection_type(self, sid, tid):
        ...
        #print(" conn0: " + str(conn0) + " Prop0: " + str(prop0) )
        #print(" conn1: " + str(conn1) + " Prop0: " + str(prop1)  )
    ...
    def make_connection(self, source, target, *args, **kwargs):
        ...
        if i < j:
            ...
            #print("Connector: " + str(self.connector) + " Conn_type:" +str(conn_type) + " p_arg: " + str(p_arg) )
...
def syn_dist_delay_feng(source, target,
    ...
    delay = float(dist) / SYN_VELOCITY + SYN_MIN_DELAY + del_fluc
